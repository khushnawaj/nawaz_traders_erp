...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            <button
              ...
              className="lg:hidden p-2 rounded-xl bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-white border border-slate-200 dark:border-slate-800 transition"
            >
          ...
          <nav className="hidden lg:flex items-center gap-1.5 bg-slate-100/80 dark:bg-slate-900/60 p-1 rounded-2xl border border-slate-200/60 dark:border-slate-800/60 backdrop-blur-md">
            {user?.role === 'EMPLOYEE' ? (
              <Link
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-md flex animate-in fade-in duration-150">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl border-t border-slate-200/80 dark:border-slate-800/80 py-2 px-3 flex items-center justify-around z-30 shadow-2xl">
        {user?.role === 'FARMER' ? (
          <>
      ...
      {fabOpen && (
        <div className="lg:hidden fixed bottom-16 right-4 z-40 glass-modal p-3 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xl space-y-2 animate-in fade-in slide-in-from-bottom-4 duration-150">
