    ...
    <main className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-in fade-in duration-200">
      ...
      {advanceModalOpen && (
        <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bahi-card-emerald max-w-lg w-full p-6 border border-slate-200/60 dark:border-slate-800/60 shadow-2xl relative space-y-5">
            <div className="flex items-center justify-between border-b border-slate-200/60 dark:border-slate-800/60 pb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-bold text-base text-slate-900 dark:text-white font-outfit">Request Salary Advance</h3>
                  <p className="text-[11px] text-slate-500">Submit a request to Nawaz Traders Management</p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleRequestAdvanceSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="bahi-input text-lg font-bold font-mono"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="bahi-btn-primary py-2 px-5 text-xs shadow-md disabled:opacity-50"
                >
                  {submittingAdvance ? (
                    <>
